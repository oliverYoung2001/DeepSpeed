...
class DeepSpeedZeroOptimizer_Stage3(ZeROOptimizer):
    ...
    def __init__(
        ...
        # print_rank_0(f'reduce_bucket_size: {reduce_bucket_size}, prefetch_bucket_size: {prefetch_bucket_size}', force=True) # 0.5G, 0.5G
        if dist.get_rank() == 0:
        ...
        # print(f'zero_hpz_partition_size: {zero_hpz_partition_size}')    # 1
        ...
        self.create_reduce_and_remove_grad_hooks()  # [NOTE]: important !!!
            ...
            for param in param_group:
                if param.requires_grad:
                    ...
                    def wrapper(param):
                        ...
                        self._grad_acc_hooks.append(grad_acc.register_hook(reduce_partition_and_remove_grads))  # [NOTE]: register hook in param-level !!!
    ...
    def backward(self, loss, retain_graph=False):
        ...
        """
        # print_rank_0(f'self.swap_optimizer: {self.swap_optimizer}', force=True) # False
        # print_rank_0(f'self.custom_loss_scaler: {self.custom_loss_scaler}', force=True) # False
